...
case $GMC in
  cont)
    ...
    KYLIEKYLER1=0; KYLIEKYLER2=117; KYLIEKYLER3=235; KYLIEKYLER4=411; KYLIEKYLER5=823; KYLIEKYLER6=1000 
    ...
    case $EAS in
      ...
      false)
        ...
        echo 75 > /proc/sys/kernel/sched_upmigrate 2>/dev/null
    ...
    echo $KYLIEKYLER1,$KYLIEKYLER2,$KYLIEKYLER3,$KYLIEKYLER4,$KYLIEKYLER5,$KYLIEKYLER6 > /sys/module/lowmemorykiller/parameters/adj;
    ...
    echo 85 > /sys/devices/system/cpu/cpu4/cpufreq/$GOV/go_hispeed_load
    echo 85 > /sys/devices/system/cpu/cpu0/cpufreq/$GOV/go_hispeed_load
    echo 85 > /sys/devices/system/cpu/cpu2/cpufreq/$GOV/go_hispeed_load
    echo 85 > /sys/devices/system/cpu/cpu1/cpufreq/$GOV/go_hispeed_load
    echo 85 > /sys/devices/system/cpu/cpu6/cpufreq/$GOV/go_hispeed_load
    echo 85 > /sys/devices/system/cpu/cpu8/cpufreq/$GOV/go_hispeed_load

    echo 85 > /sys/devices/system/cpu/cpufreq/policy0/$GOV/go_hispeed_load
    echo 85 > /sys/devices/system/cpu/cpufreq/policy2/$GOV/go_hispeed_load
    echo 85 > /sys/devices/system/cpu/cpufreq/policy4/$GOV/go_hispeed_load
    echo 85 > /sys/devices/system/cpu/cpufreq/policy6/$GOV/go_hispeed_load
    ...
    # DELAY IS HERE =======================================================//
    echo 0 > /sys/devices/system/cpu/cpu0/cpufreq/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpu1/cpufreq/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpu2/cpufreq/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpu4/cpufreq/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpu6/cpufreq/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpu8/cpufreq/$GOV/above_hispeed_delay

    echo 0 > /sys/devices/system/cpu/cpufreq/policy0/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpufreq/policy1/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpufreq/policy2/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpufreq/policy4/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpufreq/policy6/$GOV/above_hispeed_delay
    echo 0 > /sys/devices/system/cpu/cpufreq/policy8/$GOV/above_hispeed_delay
    ...
    echo 90000 > /sys/devices/system/cpu/cpu0/cpufreq/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpu1/cpufreq/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpu2/cpufreq/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpu4/cpufreq/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpu6/cpufreq/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpu8/cpufreq/$GOV/timer_slack

    echo 90000 > /sys/devices/system/cpu/cpufreq/policy0/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpufreq/policy2/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpufreq/policy4/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpufreq/policy6/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpufreq/policy8/$GOV/timer_slack
    echo 90000 > /sys/devices/system/cpu/cpufreq/policy1/$GOV/timer_slack
